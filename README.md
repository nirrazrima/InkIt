...
- Jump straight to the **next / previous shot** with the on-screen buttons or the `Alt+Down` / `Alt+Up` shortcuts — at the list's ends the current clip jumps to its last / first frame instead.
